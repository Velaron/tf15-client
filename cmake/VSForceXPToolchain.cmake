if(WIN32)
	...
	if ("${CMAKE_GENERATOR}" MATCHES "Visual Studio ([0-9]+)")
		...
		elseif (${CMAKE_MATCH_1} EQUAL 15)
			...
			message(NOTICE "WARNING: You maybe building without Windows XP compability. See which toolchain version Visual Studio provides, and say cmake to use it: cmake -G \"Visual Studio XX\" -T \"vXXX_xp\"")
		endif()
	endif()
endif()
